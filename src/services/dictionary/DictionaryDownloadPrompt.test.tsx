...
describe("DictionaryDownloadPrompt", () => {
  ...
  it("should render when opened", () => {
    ...
    expect(screen.getByText("Enable Offline Dictionary")).toBeInTheDocument();
    // expect(screen.getByText(/Enable Offline Dictionary/i)).toBeInTheDocument();
    expect(
      screen.getByText(/Would you like to download it now\?/i),
    ).toBeInTheDocument();
  ...
  it("should start download and show progress", async () => {
    ...
    expect(screen.getByText("Downloading dictionary data...")).toBeInTheDocument();
    ...
    expect(screen.getByText("Extracting dictionary data...")).toBeInTheDocument();
  ...
  it("should handle download failure", async () => {
    vi.mocked(downloadAndInstallWordNet).mockRejectedValue(
    ...
    await waitFor(() => {
      ...
      expect(screen.getByText("Download Now")).not.toHaveAttribute(
        "data-loading",
      );
    });
